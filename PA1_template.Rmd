...
On average the time interval at `r max_steps` had the maximum steps.
...
There were `r num_na` rows in the activity data with missing values.
...
The mean total number of steps taken per day is `r mean_steps2`.

The median total number of steps taken per day is `r median_steps2`.
